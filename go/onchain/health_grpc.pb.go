...
const (
	HealthService_Check_FullMethodName = "/onchain.v1.HealthService/Check"
)
...
func (c *healthServiceClient) Check(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (UnimplementedHealthServiceServer) Check(context.Context, *Empty) (*HealthResponse, error) {
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "onchain.v1.HealthService",
