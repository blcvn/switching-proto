...
import com.blcvn.switching.accesspoint.EventsServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for accesspoint.v1.EventsService.
 */
public object EventsServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) accesspoint.v1.EventsService service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the accesspoint.v1.EventsService service based on Kotlin coroutines.
   */
  public abstract class EventsServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns a [Flow] of responses to an RPC for accesspoint.v1.EventsService.SubscribeEvents.
     *
    ...
    public open fun subscribeEvents(request: Events.SubscribeEventsRequest): Flow<Events.Event> =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.EventsService.SubscribeEvents is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.EventsService.RegisterCallback.
     *
    ...
    public open suspend fun registerCallback(request: Events.SubscribeCallbackRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.EventsService.RegisterCallback is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.EventsService.UnregisterCallback.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun unregisterCallback(request: Events.UnsubscribeCallbackRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.EventsService.UnregisterCallback is unimplemented"))
