...
import com.blcvn.switching.accesspoint.GpiServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for accesspoint.v1.GpiService.
 */
public object GpiServiceGrpcKt {
  ...
  /**
   * Skeletal implementation of the accesspoint.v1.GpiService service based on Kotlin coroutines.
   */
  public abstract class GpiServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for accesspoint.v1.GpiService.CreatePayment.
     *
    ...
    public open suspend fun createPayment(request: Gpi.CreatePaymentRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.GpiService.CreatePayment is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.GpiService.GetPayment.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    /**
     * Returns the response to an RPC for accesspoint.v1.GpiService.GetPaymentStatus.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
