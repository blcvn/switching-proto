...
import com.blcvn.switching.accesspoint.KycServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for accesspoint.v1.KycService.
 */
public object KycServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) accesspoint.v1.KycService service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the accesspoint.v1.KycService service based on Kotlin coroutines.
   */
  public abstract class KycServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for accesspoint.v1.KycService.ListEntities.
     *
    ...
    public open suspend fun listEntities(request: Common.Empty): Kyc.ListEntitiesResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.KycService.ListEntities is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.KycService.GetEntity.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun getEntity(request: Kyc.GetEntityRequest): Common.KycEntity = throw
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.KycService.GetEntity is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.KycService.GetEntityDocuments.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun getEntityDocuments(request: Kyc.GetEntityDocsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.KycService.GetEntityDocuments is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.KycService.SubmitKyc.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun submitKyc(request: Kyc.SubmitKycRequest): Kyc.SubmitKycResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.KycService.SubmitKyc is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.KycService.Metadata.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun metadata(request: Common.Empty): Kyc.KycMetadata = throw
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.KycService.Metadata is unimplemented"))

    /**
     * Returns the response to an RPC for accesspoint.v1.KycService.Audit.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun audit(request: Kyc.GetEntityRequest): Kyc.AuditResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method accesspoint.v1.KycService.Audit is unimplemented"))
