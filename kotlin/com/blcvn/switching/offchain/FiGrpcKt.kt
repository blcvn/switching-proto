...
import com.blcvn.switching.offchain.FiServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for offchain.v1.FiService.
 */
public object FiServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) offchain.v1.FiService service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the offchain.v1.FiService service based on Kotlin coroutines.
   */
  public abstract class FiServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for offchain.v1.FiService.CreateTransfer.
     *
    ...
    public open suspend fun createTransfer(request: Fi.CreateTransferRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method offchain.v1.FiService.CreateTransfer is unimplemented"))

    /**
     * Returns the response to an RPC for offchain.v1.FiService.GetTransfer.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun getTransfer(request: Fi.GetTransferRequest): Common.Transfer = throw
        StatusException(UNIMPLEMENTED.withDescription("Method offchain.v1.FiService.GetTransfer is unimplemented"))

    /**
     * Returns the response to an RPC for offchain.v1.FiService.GetTransferStatus.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun getTransferStatus(request: Fi.GetTransferRequest): Fi.TransferStatus =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method offchain.v1.FiService.GetTransferStatus is unimplemented"))

    /**
     * Returns the response to an RPC for offchain.v1.FiService.ConfirmTransfer.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun confirmTransfer(request: Fi.ConfirmTransferRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method offchain.v1.FiService.ConfirmTransfer is unimplemented"))

    /**
     * Returns the response to an RPC for offchain.v1.FiService.SearchTransfers.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun searchTransfers(request: Fi.SearchTransfersRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method offchain.v1.FiService.SearchTransfers is unimplemented"))

    /**
     * Returns the response to an RPC for offchain.v1.FiService.BulkTransfer.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun bulkTransfer(request: Fi.BulkTransferRequest): Fi.BulkTransferResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method offchain.v1.FiService.BulkTransfer is unimplemented"))
