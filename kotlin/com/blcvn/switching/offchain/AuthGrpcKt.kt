...
import com.blcvn.switching.offchain.AuthServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for offchain.v1.AuthService.
 */
public object AuthServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) offchain.v1.AuthService service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the offchain.v1.AuthService service based on Kotlin coroutines.
   */
  public abstract class AuthServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for offchain.v1.AuthService.Token.
     *
    ...
    public open suspend fun token(request: Auth.TokenRequest): Auth.TokenResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method offchain.v1.AuthService.Token is unimplemented"))
