...
public object TransactionServiceGrpcKt {
  ...
  public val registerBankMethod: MethodDescriptor<Common.KycEntity, Common.KycEntity>
    @JvmStatic
    get() = TransactionServiceGrpc.getRegisterBankMethod()

  public val getBankInfoMethod: MethodDescriptor<Common.KycEntity, Common.KycEntity>
    @JvmStatic
    get() = TransactionServiceGrpc.getGetBankInfoMethod()
  ...
  public class TransactionServiceCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    public suspend fun registerBank(request: Common.KycEntity, headers: Metadata = Metadata()):
        Common.KycEntity = unaryRpc(
      channel,
      TransactionServiceGrpc.getRegisterBankMethod(),
      request,
      callOptions,
      headers
    )
     ...
     * @return The single response from the server.
     */
    public suspend fun getBankInfo(request: Common.KycEntity, headers: Metadata = Metadata()):
        Common.KycEntity = unaryRpc(
      channel,
      TransactionServiceGrpc.getGetBankInfoMethod(),
      request,
      callOptions,
      headers
    )
  ...
  public abstract class TransactionServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for onchain.v1.TransactionService.RegisterBank.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
     ...
     * @param request The request from the client.
     */
    public open suspend fun registerBank(request: Common.KycEntity): Common.KycEntity = throw
        StatusException(UNIMPLEMENTED.withDescription("Method onchain.v1.TransactionService.RegisterBank is unimplemented"))

    /**
     * Returns the response to an RPC for onchain.v1.TransactionService.GetBankInfo.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
     ...
     * @param request The request from the client.
     */
    public open suspend fun getBankInfo(request: Common.KycEntity): Common.KycEntity = throw
        StatusException(UNIMPLEMENTED.withDescription("Method onchain.v1.TransactionService.GetBankInfo is unimplemented"))
    ...
    final override fun bindService(): ServerServiceDefinition = builder(getServiceDescriptor())
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = TransactionServiceGrpc.getRegisterBankMethod(),
      implementation = ::registerBank
    ))
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = TransactionServiceGrpc.getGetBankInfoMethod(),
      implementation = ::getBankInfo
    )).build()
  }
}
